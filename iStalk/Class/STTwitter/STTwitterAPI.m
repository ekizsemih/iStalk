...
- (NSObject<STTwitterRequestProtocol> *)getStatusesMentionTimelineWithCount:(NSString *)count
    ...
    return [self getAPIResource:@"statuses/mentions_timeline.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)getStatusesUserTimelineForUserID:(NSString *)userID
    ...
    return [self getAPIResource:@"statuses/user_timeline.json" parameters:md accesstoken:accesstoken accesstokensecret:accesstokensecret successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getStatusesHomeTimelineWithCount:(NSString *)count
    ...
    return [self getAPIResource:@"statuses/home_timeline.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getStatusesRetweetsOfMeWithCount:(NSString *)count
    ...
    return [self getAPIResource:@"statuses/retweets_of_me.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getStatusesRetweetsForID:(NSString *)statusID
    ...
    return [self getAPIResource:resource parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getStatusesShowID:(NSString *)statusID
    ...
    return [self getAPIResource:@"statuses/show.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getStatusesOEmbedForStatusID:(NSString *)statusID
    ...
    return [self getAPIResource:@"statuses/oembed.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getStatusesRetweetersIDsForStatusID:(NSString *)statusID
    ...
    return [self getAPIResource:@"statuses/retweeters/ids.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)getListsSubscriptionsForUserID:(NSString *)userID
    ...
    return [self getAPIResource:@"lists/subscriptions.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)getListsOwnershipsForUserID:(NSString *)userID
    ...
    return [self getAPIResource:@"lists/ownerships.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)getSearchTweetsWithQuery:(NSString *)q
    ...
    return [self getAPIResource:@"search/tweets.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)getDirectMessagesSinceID:(NSString *)sinceID
    ...
    return [self getAPIResource:@"direct_messages.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getDirectMessagesSinceID:(NSString *)sinceID
    ...
    return [self getAPIResource:@"direct_messages/sent.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getDirectMessagesShowWithID:(NSString *)messageID
    ...
    return [self getAPIResource:@"direct_messages/show.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getFriendshipNoRetweetsIDsWithSuccessBlock:(void(^)(NSArray *ids))successBlock
    ...
    return [self getAPIResource:@"friendships/no_retweets/ids.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getFriendsIDsForUserID:(NSString *)userID
    ...
    return [self getAPIResource:@"friends/ids.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        NSArray *ids = nil;
        NSString *previousCursor = nil;
        NSString *nextCursor = nil;
...
- (NSObject<STTwitterRequestProtocol> *)getFollowersIDsForUserID:(NSString *)userID
    ...
    return [self getAPIResource:@"followers/ids.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)getFriendshipsLookupForScreenNames:(NSArray *)screenNames
    ...
    return [self getAPIResource:@"friendships/lookup.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getFriendshipIncomingWithCursor:(NSString *)cursor
    ...
    return [self getAPIResource:@"friendships/incoming.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        NSArray *ids = nil;
        NSString *previousCursor = nil;
        NSString *nextCursor = nil;
...
- (NSObject<STTwitterRequestProtocol> *)getFriendshipOutgoingWithCursor:(NSString *)cursor
    ...
    return [self getAPIResource:@"friendships/outgoing.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        NSArray *ids = nil;
        NSString *previousCursor = nil;
        NSString *nextCursor = nil;
...
- (NSObject<STTwitterRequestProtocol> *)getFriendshipShowForSourceID:(NSString *)sourceID
    ...
    return [self getAPIResource:@"friendships/show.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getFriendsListForUserID:(NSString *)userID
    ...
    return [self getAPIResource:@"friends/list.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        NSArray *users = nil;
        NSString *previousCursor = nil;
        NSString *nextCursor = nil;
...
- (NSObject<STTwitterRequestProtocol> *)getFollowersListForUserID:(NSString *)userID
    ...
    return [self getAPIResource:@"followers/list.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        NSArray *users = nil;
        NSString *previousCursor = nil;
        NSString *nextCursor = nil;
...
- (NSObject<STTwitterRequestProtocol> *)getAccountSettingsWithSuccessBlock:(void(^)(NSDictionary *settings))successBlock
                                                                errorBlock:(void(^)(NSError *error))errorBlock {
    return [self getAPIResource:@"account/settings.json" parameters:nil accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getAccountVerifyCredentialsWithIncludeEntites:(NSNumber *)includeEntities
    ...
    return [self getAPIResource:@"account/verify_credentials.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getBlocksListWithincludeEntities:(NSNumber *)includeEntities
    ...
    return [self getAPIResource:@"blocks/list.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)getBlocksIDsWithCursor:(NSString *)cursor
    ...
    return [self getAPIResource:@"blocks/ids.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)getUsersLookupForScreenName:(NSString *)screenName
    ...
    return [self getAPIResource:@"users/lookup.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getUsersShowForUserID:(NSString *)userID
    ...
    return [self getAPIResource:@"users/show.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getUsersSearchQuery:(NSString *)query
    ...
    return [self getAPIResource:@"users/search.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)getUsersContributeesWithUserID:(NSString *)userID
    ...
    return [self getAPIResource:@"users/contributees.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getUsersContributorsWithUserID:(NSString *)userID
    ...
    return [self getAPIResource:@"users/contributors.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getUsersProfileBannerForUserID:(NSString *)userID
    ...
    return [self getAPIResource:@"users/profile_banner.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getUsersSuggestionsWithISO6391LanguageCode:(NSString *)ISO6391LanguageCode
    ...
    return [self getAPIResource:@"users/suggestions.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getMutesUsersIDsWithCursor:(NSString *)cursor
    ...
    return [self getAPIResource:@"mutes/users/ids.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)getMutesUsersListWithCursor:(NSString *)cursor
    ...
    return [self getAPIResource:@"mutes/users/list.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)getUsersSuggestionsForSlug:(NSString *)slug // short name of list or a category, eg. "twitter"
    ...
    return [self getAPIResource:@"users/suggestions/twitter.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        NSString *name = nil;
        NSString *slug = nil;
        NSArray *users = nil;
...
- (NSObject<STTwitterRequestProtocol> *)getFavoritesListWithUserID:(NSString *)userID
    ...
    return [self getAPIResource:@"favorites/list.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getListsSubscribedByUsername:(NSString *)username
    ...
    return [self getAPIResource:@"lists/list.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)getListsStatusesForListID:(NSString *)listID
    ...
    return [self getAPIResource:@"lists/statuses.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)getListsMembershipsForUserID:(NSString *)userID
    ...
    return [self getAPIResource:@"lists/memberships.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        NSString *previousCursor = nil;
        NSString *nextCursor = nil;
        NSArray *lists = nil;
...
- (NSObject<STTwitterRequestProtocol> *)getListsSubscribersForSlug:(NSString *)slug
    ...
    return [self getAPIResource:@"lists/subscribers.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        NSArray *users = [response valueForKey:@"users"];
        NSString *previousCursor = [response valueForKey:@"previous_cursor_str"];
        NSString *nextCursor = [response valueForKey:@"next_cursor_str"];
        successBlock(users, previousCursor, nextCursor);
...
- (NSObject<STTwitterRequestProtocol> *)getListsSubscribersShowForListID:(NSString *)listID
    ...
    return [self getAPIResource:@"lists/subscribers/show.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getListsMembersShowForListID:(NSString *)listID
    ...
    return [self getAPIResource:@"lists/members/show.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getListsMembersForListID:(NSString *)listID
    ...
    return [self getAPIResource:@"lists/members.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        NSArray *users = [response valueForKey:@"users"];
        NSString *previousCursor = [response valueForKey:@"previous_cursor_str"];
        NSString *nextCursor = [response valueForKey:@"next_cursor_str"];
        successBlock(users, previousCursor, nextCursor);
...
- (NSObject<STTwitterRequestProtocol> *)getListsShowListID:(NSString *)listID
    ...
    return [self getAPIResource:@"lists/show.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getSavedSearchesListWithSuccessBlock:(void(^)(NSArray *savedSearches))successBlock
    ...
    return [self getAPIResource:@"saved_searches/list.json" parameters:nil accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getSavedSearchesShow:(NSString *)savedSearchID
    ...
    return [self getAPIResource:resource parameters:nil accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getGeoReverseGeocodeWithLatitude:(NSString *)latitude // eg. "37.7821120598956"
    ...
    return [self getAPIResource:@"geo/reverse_geocode.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)getTrendsForWOEID:(NSString *)WOEID // 'Yahoo! Where On Earth ID', Paris is "615702"
    ...
    return [self getAPIResource:@"trends/place.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)getTrendsAvailableWithSuccessBlock:(void(^)(NSArray *locations))successBlock
                                                                errorBlock:(void(^)(NSError *error))errorBlock {
    return [self getAPIResource:@"trends/available.json" parameters:nil accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getTrendsClosestToLatitude:(NSString *)latitude
    ...
    return [self getAPIResource:@"trends/closest.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getHelpConfigurationWithSuccessBlock:(void(^)(NSDictionary *currentConfiguration))successBlock
                                                                  errorBlock:(void(^)(NSError *error))errorBlock {
    return [self getAPIResource:@"help/configuration.json" parameters:nil accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getHelpLanguagesWithSuccessBlock:(void (^)(NSArray *languages))successBlock
                                                              errorBlock:(void (^)(NSError *))errorBlock {
    return [self getAPIResource:@"help/languages.json" parameters:nil accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getHelpPrivacyWithSuccessBlock:(void(^)(NSString *tos))successBlock
                                                            errorBlock:(void(^)(NSError *error))errorBlock {
    return [self getAPIResource:@"help/privacy.json" parameters:nil accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)getHelpTermsOfServiceWithSuccessBlock:(void(^)(NSString *tos))successBlock
                                                                   errorBlock:(void(^)(NSError *error))errorBlock {
    return [self getAPIResource:@"help/tos.json" parameters:nil accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)getRateLimitsForResources:(NSArray *)resources // eg. statuses,friends,trends,help
    ...
    return [self getAPIResource:@"application/rate_limit_status.json" parameters:d accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)getStatusesLookupTweetIDs:(NSArray *)tweetIDs
    ...
    return [self getAPIResource:@"statuses/lookup.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)_getActivityAboutMeSinceID:(NSString *)sinceID
    ...
    return [self getAPIResource:@"activity/about_me.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)_getActivityByFriendsSinceID:(NSString *)sinceID
    ...
    return [self getAPIResource:@"activity/by_friends.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)_getConversationShowForStatusID:(NSString *)statusID
    ...
    return [self getAPIResource:@"conversation/show.json" parameters:d accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)_getDiscoverHighlightWithSuccessBlock:(void(^)(NSDictionary *metadata, NSArray *modules))successBlock
    ...
    return [self getAPIResource:@"discover/highlight.json" parameters:nil accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)_getDiscoverUniversalWithSuccessBlock:(void(^)(NSDictionary *metadata, NSArray *modules))successBlock
    ...
    return [self getAPIResource:@"discover/universal.json" parameters:nil accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)_getMediaTimelineWithSuccessBlock:(void(^)(NSArray *statuses))successBlock
    ...
    return [self getAPIResource:@"statuses/media_timeline.json" parameters:nil accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
...
- (NSObject<STTwitterRequestProtocol> *)_getUsersRecommendationsWithSuccessBlock:(void(^)(NSArray *recommendations))successBlock
    ...
    return [self getAPIResource:@"users/recommendations.json" parameters:nil accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)_getTimelineHomeWithSuccessBlock:(void(^)(id response))successBlock
    ...
    return [self getAPIResource:@"timeline/home.json" parameters:nil accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)_getSearchTypeaheadQuery:(NSString *)query
    ...
    return [self getAPIResource:@"search/typeahead.json" parameters:md accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)_getConversationShowWithTweetID:(NSString *)tweetID
    ...
    return [self getAPIResource:ressource parameters:nil accesstoken:nil accesstokensecret:nil successBlock:^(NSDictionary *rateLimits, id response) {
        successBlock(response);
    } errorBlock:^(NSError *error) {
        errorBlock(error);
    }];
...
- (NSObject<STTwitterRequestProtocol> *)_getScheduleStatusesWithCount:(NSString *)count
    ...
    return [self getAPIResource:@"schedule/status/list.json"
                     parameters:md
                    accesstoken:nil accesstokensecret:nil
                   successBlock:^(NSDictionary *rateLimits, id response) {
                       successBlock(response);
                   } errorBlock:^(NSError *error) {
                       errorBlock(error);
